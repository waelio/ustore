...
exports.cookieStorage = ({
    ...
    set: function (key, value) {
        try {
            isReady ? window.document.cookie = "".concat(key, "=").concat(value) : exports.memoryStore = __assign({ key: value });
            return true;
        }
        catch (error) {
            return error || null;
    ...
    remove: function (key) {
        try {
            isReady ? window.document.cookie = "".concat(key, "=; expires=Thu, 01 Jan 1970 00:00:01 GMT;") : exports.memoryStore = __assign({ key: null });
            return true;
        }
        catch (error) {
            return error || null;
