...
exports.uStoreStorage = exports.IUStoreClass = exports.STATCSTORESNAMES = exports.createApp = exports.app = void 0;
...
})(STATCSTORESNAMES = exports.STATCSTORESNAMES || (exports.STATCSTORESNAMES = {}));
class IUStoreClass {
    constructor(plugin, options) {
        ...
        this._server = (options === null || options === void 0 ? void 0 : options.server)
            ...
            : {};
        this._client = (options === null || options === void 0 ? void 0 : options.client)
            ? options.client
            : {
                init: false,
                app: {
        ...
        this._dev = (options === null || options === void 0 ? void 0 : options.dev)
            ? options.dev
            : {
                debug: false,
                localeName: "locale",
        ...
        this._storage = (options === null || options === void 0 ? void 0 : options.storage)
            ? options.storage
            : localStorage;
...
exports.IUStoreClass = IUStoreClass;
exports.uStoreStorage = new IUStoreClass();
