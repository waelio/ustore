...
(function (StoreTypes) {
    ...
    StoreTypes["solid"] = "solidStorage";
    StoreTypes["idb"] = "idbStorage";
    StoreTypes["webql"] = "webqlStorage";
    StoreTypes["rxjs"] = "rxjsStorage";
    StoreTypes["secure"] = "secureStorage";
    StoreTypes["config"] = "configStorage";
    StoreTypes["signal"] = "signalStorage";
...
(function (StorePlugins) {
    ...
    StorePlugins["solid"] = "solidStorage";
    StorePlugins["idb"] = "idbStorage";
    StorePlugins["webql"] = "webqlStorage";
    StorePlugins["rxjs"] = "rxjsStorage";
    StorePlugins["secure"] = "secureStorage";
    StorePlugins["config"] = "configStorage";
    StorePlugins["signal"] = "signalStorage";
