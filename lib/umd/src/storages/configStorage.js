(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../../config/index"], factory);
    }
    ...
    class Config {
        constructor(plugin, options) {
            const _ = this;
            this.setEnvironment();
            this._server = (options === null || options === void 0 ? void 0 : options.server) ? options.server : _.getServerVars();
            this._client = (options === null || options === void 0 ? void 0 : options.client) ? options.client : index_1.client;
            this._dev = (options === null || options === void 0 ? void 0 : options.dev) ? options.dev : _.getUrgentOverrides();
            this._prod = (options === null || options === void 0 ? void 0 : options.prod) ? options.prod : index_1.prod;
            this._plugin = plugin || {};
