(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "./localStorage", "./sessionStorage", "./cookieStorage", "./memoryStorage", "./vuexStorage", "./piniaStorage", "./piniaStorage", "./piniaStorage", "./uStoreStorage", "./gunStorage", "./secureStorage", "./configStorage", "./configStorage", "./idbStorage", "./webqlStorage"], factory);
    }
