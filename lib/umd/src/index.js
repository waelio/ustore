(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "./_stores/localStorage", "./_stores/sessionStorage", "./_stores/cookieStorage", "./_stores/memoryStorage", "./_stores/vuexStorage", "./_stores/piniaStorage", "./_stores/gunStorage", "./_stores/secureStorage", "./_stores/configStorage", "./_stores/signalStorage", "./messaging/index"], factory);
    }
})(function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.createMessagingStore = exports.signalStorage = exports.configStorage = exports.secureStorage = exports.gunStorage = exports.piniaStorage = exports.vuexStorage = exports.memoryStorage = exports.cookieStorage = exports.sessionStorage = exports.localStorage = exports.uStore = void 0;
