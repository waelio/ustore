...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "./storages/configStorage", "./storages/cookieStorage", "./storages/gunStorage", "./storages/idbStorage", "./storages/memoryStorage", "./storages/piniaStorage", "./storages/secureStorage", "./storages/index", "./storages/webqlStorage", "./storages/localStorage", "./storages/sessionStorage", "./storages/uStoreStorage"], factory);
    }
    ...
    const configStorage_1 = __importStar(require("./storages/configStorage"));
    ...
    const cookieStorage_1 = __importDefault(require("./storages/cookieStorage"));
    exports.cookieStorage = cookieStorage_1.default;
    const gunStorage_1 = __importDefault(require("./storages/gunStorage"));
    exports.gunStorage = gunStorage_1.default;
    const idbStorage_1 = __importDefault(require("./storages/idbStorage"));
    exports.idbStorage = idbStorage_1.default;
    const memoryStorage_1 = __importDefault(require("./storages/memoryStorage"));
    exports.memoryStorage = memoryStorage_1.default;
    const piniaStorage_1 = __importStar(require("./storages/piniaStorage"));
    ...
    exports.uStore = {
        ...
        cookie: cookieStorage_1.default,
