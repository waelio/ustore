(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "./stores/configStorage", "./stores/localStorage", "./stores/sessionStorage", "./stores/cookieStorage", "./stores/memoryStorage", "./stores/vuexStorage", "./stores/piniaStorage", "./stores/gunStorage", "./stores"], factory);
    }
})(function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.configStorage = exports.secureStorage = exports.gunStorage = exports.piniaStorage = exports.vuexStorage = exports.memoryStorage = exports.cookieStorage = exports.sessionStorage = exports.localStorage = exports.uStore = void 0;
    const configStorage_1 = require("./stores/configStorage");
