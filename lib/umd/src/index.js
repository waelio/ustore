(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "./stores/localStorage", "./stores/sessionStorage", "./stores/cookieStorage", "./stores/memoryStorage", "./stores/vuexStorage", "./stores/piniaStorage", "./stores/gunStorage", "./stores", "./stores"], factory);
    }
