(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "./localStorage", "./sessionStorage", "./cookieStorage", "./memoryStorage", "./vuexStorage", "./piniaStorage", "./gunStorage", "./secureStorage", "./configStorage"], factory);
    }
