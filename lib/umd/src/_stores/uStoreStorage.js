(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "vue", "./memoryStorage", "./secureStorage", "./sessionStorage", "./configStorage", "./cookieStorage", "./gunStorage", "./idbStorage", "./localStorage", "./piniaStorage", "./vuexStorage", "./webqlStorage"], factory);
    }
