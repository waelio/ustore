(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "waelio-utils"], factory);
    }
    ...
    const secureStorage = {
        ...
        getItem: function (key, options) {
            return options && options.salt ? (0, waelio_utils_1._decrypt)(memoryStore[key], options.salt) : (0, waelio_utils_1._decrypt)(memoryStore[key]);
        },
        set: function (key, value, options) {
            memoryStore[key] = options && options.salt ? (0, waelio_utils_1._encrypt)(value, options.salt) : (0, waelio_utils_1._encrypt)(value);
