(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "./localStorage", "./sessionStorage", "./cookieStorage", "./memoryStorage", "./secureStorage", "./vuexStorage", "./piniaStorage", "./gunStorage", "./configStorage", "./idbStorage", "./webqlStorage", "./signalStorage", "./rxjsStorage"], factory);
    }
    ...
    const rxjsStorage_1 = require("./rxjsStorage");
