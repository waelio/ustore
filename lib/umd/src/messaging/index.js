(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../_stores/localStorage", "../_stores/sessionStorage", "../_stores/signalStorage"], factory);
    }
})(function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.createMessagingStore = void 0;
    ...
    function createMessagingStore(socket, options = {}) {
        const { historyLimit = 200, storagePrefix = "wm" } = options;
        let userId = sessionStorage_1.sessionStorage.get(SESSION_USER_ID_KEY) || null;
        let connected = false;
        let roomId = null;
        ...
        function getCachedHistory() {
            const stored = localStorage_1.localStorage.get(currentHistoryKey());
        ...
        function appendToCache(msg) {
            ...
            localStorage_1.localStorage.set(currentHistoryKey(), history);
        }
        function setState(key, value) {
            signalStorage_1.signalStorage.set(signalKey(storagePrefix, key), value);
        }
        function getState(key) {
            return signalStorage_1.signalStorage.get(signalKey(storagePrefix, key));
        }
        function handleRegister(msg) {
            ...
            if (!id)
                return;
            userId = id;
            sessionStorage_1.sessionStorage.set(SESSION_USER_ID_KEY, id);
            connected = true;
        ...
        function handleHistory(msg) {
            ...
            localStorage_1.localStorage.set(currentHistoryKey(), limited);
        ...
        return {
            ...
            setDisplayName(name) {
                sessionStorage_1.sessionStorage.set(SESSION_DISPLAY_NAME_KEY, name);
            },
            getDisplayName() {
                return sessionStorage_1.sessionStorage.get(SESSION_DISPLAY_NAME_KEY) ?? null;
            },
            send(to, payload) {
            ...
            getCachedHistory,
            clearHistory() {
                localStorage_1.localStorage.remove(currentHistoryKey());
            },
            getUnread() {
    ...
    exports.createMessagingStore = createMessagingStore;
});
