(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('waelio-utils'), require('vue')) :
    typeof define === 'function' && define.amd ? define(['exports', 'waelio-utils', 'vue'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.UniversalStore = {}, global.waelioUtils, global.vue));
})(this, (function (exports, waelioUtils, vue) { 'use strict';
    ...
    })(exports.StoreTypes || (exports.StoreTypes = {}));
    ...
    const uStoreGunDB = db.get(storeName);
    ...
    const gunStorage = {
        ...
        remove: async (key) => {
            const test = await waelioUtils._To(uStoreGunDB.get(key).put({ _: '#' }));
    ...
    const initialStore = exports.StoreTypes.local;
    const UniversalStore = (storePluginType = initialStore) => {
        switch (storePluginType) {
            case exports.StoreTypes.local:
                return localStorage$1;
            case exports.StoreTypes.session:
                return sessionStorage;
            case exports.StoreTypes.cookie:
                return cookieStorage;
            case exports.StoreTypes.memory:
                return memoryStorage;
            case exports.StoreTypes.vuex:
                return vuexStorage;
            case exports.StoreTypes.pinia:
                return piniaStorage;
            case exports.StoreTypes.gun:
                return gunStorage;
            default:
                return localStorage$1;
        }
    ...
    exports.UniversalStore = UniversalStore;
    exports.cookieStorage = cookieStorage;
    exports["default"] = UniversalStore;
    exports.gunStorage = gunStorage;
    exports.localStorage = localStorage$1;
    exports.memoryStorage = memoryStorage;
    exports.piniaStorage = piniaStorage;
    exports.sessionStorage = sessionStorage;
    exports.vuexStorage = vuexStorage;
