...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "./configStorage", "./cookieStorage", "./idbStorage", "./gunStorage", "./localStorage", "./memoryStorage", "./piniaStorage", "./secureStorage", "./sessionStorage", "./vuexStorage", "./webqlStorage", "./uStoreStorage", "pinia", "pinia", "./uStoreStorage", "store2", "vue", "vuex", "pinia", "gun", "waelio-utils"], factory);
    }
    ...
    const uStoreStorage_2 = require("./uStoreStorage");
